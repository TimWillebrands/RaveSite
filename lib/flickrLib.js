(function() {
    ...
    module.exports.uploadImageToFlickr = function(imagePath,image,callback,res){
        api({
            method: 'upload',
            title: image.title,
    ...
    module.exports.deletePhoto = function(photoid,callback){
        api({method: 'flickr.photos.delete', photo_id: photoid}, function(err, response) {
            if(callback){
                ...
                if(err){
                    ...
                    console.info("[flickrlib] Deleted photo: ",photoid);
